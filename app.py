...
# Storage limits for each medicine
...
if uploaded_file is not None:
    ...
    # Report generation
    report = f"""
Medicine Temperature Stability Report

Medicine Type: {medicine_type}

Safe Storage Range: {lower_limit}°C to {upper_limit}°C

Average Temperature: {avg_temp:.2f}°C
Maximum Temperature: {max_temp:.2f}°C
Minimum Temperature: {min_temp:.2f}°C

Mean Kinetic Temperature (MKT): {mkt_celsius:.2f}°C

Exposure Hours Above Limit: {exceed_hours}
Exposure Hours Below Limit: {below_hours}
...
"""
    ...
    st.download_button(
        ...
        data=report,
        file_name="stability_report.txt",
        mime="text/plain"
    )